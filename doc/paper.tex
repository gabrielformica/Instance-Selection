...
\usepackage[utf8]{inputenc}% bold math
...
\title[Sample title]{Selección de Instancias}% Force line breaks with \\

\author{Formica, Gabriel}
\author{Ponte, José Antonio}%
\affiliation{ 
Universidad Simón Bolívar%\\This line break forced with \textbackslash\textbackslash
}%

\author{C. Author}
 \homepage{http://www.Second.institution.edu/~Charlie.Author.}
\affiliation{%
Universidad Simón Bolívar%\\This line break forced% with \\
}%
...
\section{\label{sec:level1} Definición del Problema}
...
\subsubsection{\label{sec:level3}Representación}
